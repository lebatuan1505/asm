                    ...
                    <table class="table table-condensed" id="danhsach">
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <td>{{$tin->tomTat}}</td>
                            <td><img src="user/{{$tin->urlHinh}}" style="width:100px;height:100px;"></td>
                            ...
                            <td class="text-center">
                                <div class="btn-group">         
                                    ...
                                    <a href="{{route('capnhat_bv',['id'=>$tin->id])}}" data-toggle="tooltip" title="" class="btn btn-xs btn-success" data-original-title="Sửa"><i class="fa fa-pencil"></i></a>
                                    
                                    <a href="{{route('xoa_bv',['id'=>$tin->id])}}"  data-toggle="tooltip" title="" class="btn btn-xs btn-danger" data-original-title="Xóa"><i class="fa fa-times"></i></a>
