            ...
            <div id="inner-container">
                ...
                <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <nav id="primary-nav">
                        <ul>
                            <li>
                                <a href="/admin" class="active"><i class="fa fa-fire"></i>Trang Chủ</a>
                            </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="/list_cate"><i class="fa fa-file-text"></i>Danh Sách Danh Mục</a>
                                    </li>
                                    <li>
                                        <a href="/add_cate"><i class="fa fa-exclamation-triangle"></i>Thêm Danh Mục Mới</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="/list_blog"><i class="fa fa-tint"></i>Danh Sách Bài Viết</a>
                                    </li>
                                    <li>
                                        <a href="/add_blog"><i class="fa fa-picture-o"></i>Viết Bài Mới</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="/list_acc"><i class="fa fa-tint"></i>Danh Sách </a>
                                    </li>
                                    <!-- <li>
